...
> Current release: `v0.3.23`. The project is still moving quickly. APIs, packaging, runtime distribution, and UI details may continue to change.
...
- macOS Apple Silicon DMG: `Hermes.Agent.CN.Desktop_0.3.23_aarch64.dmg`
- macOS Intel DMG: `Hermes.Agent.CN.Desktop_0.3.23_x64.dmg`
- Windows x64 installer: `Hermes.Agent.CN.Desktop_0.3.23_x64-setup.exe`
