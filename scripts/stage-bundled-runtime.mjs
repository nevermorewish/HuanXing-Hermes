...
Options:
  --base-url <url>        Runtime feed base URL. When set, repo/tag are ignored.
...
const explicitBaseUrl = argValue("--base-url", process.env.HERMES_RUNTIME_UPDATE_BASE_URL ?? "");
